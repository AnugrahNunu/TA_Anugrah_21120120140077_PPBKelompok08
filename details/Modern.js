    ...
    useEffect(() => {
        async function fetchdata() {
            const request = await axios
                .get("http://192.168.42.59:3000/Modern")
                .then((res) => {
            ...
            <ScrollView>
                <Card style={styles.bodyCard}>
                    <Card.Content>
                        ...
                        <View style={styles.contenCard}>
                            <Card.Cover source={require("../assets/Modern/vas.jpg")} style={styles.imageCard} />
                            <View>
                ...
                <Card style={styles.bodyCard}>
                    <Card.Content>
                        ...
                        <View style={styles.contenCard}>
                            <Card.Cover source={require("../assets/Modern/sofa.jpg")} style={styles.imageCard} />
                            <View>
                                <Text style={styles.descCard}>{info.slice(8, 9).map((info) => (info.desc))}</Text>
                ...
                <Card style={styles.bodyCard}>
                    <Card.Content>
                        ...
                        <View style={styles.contenCard}>
                            <Card.Cover source={require("../assets/Modern/lukisan.jpg")} style={styles.imageCard} />
                            <View>
                                <Text style={styles.descCard}>{info.slice(8, 9).map((info) => (info.desc))}</Text>
                ...
                <Card style={styles.bodyCard}>
                    <Card.Content>
                        ...
                        <View style={styles.contenCard}>
                            <Card.Cover source={require("../assets/Modern/meja.jpg")} style={styles.imageCard} />
                            <View>
                                <Text style={styles.descCard}>{info.slice(8, 9).map((info) => (info.desc))}</Text>
                ...
                <Card style={styles.bodyCard}>
                    <Card.Content>
                        ...
                        <View style={styles.contenCard}>
                            <Card.Cover source={require("../assets/Modern/kursi.jpg")} style={styles.imageCard} />
                            <View>
                                <Text style={styles.descCard}>{info.slice(8, 9).map((info) => (info.desc))}</Text>
