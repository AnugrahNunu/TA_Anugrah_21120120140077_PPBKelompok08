...
function KasurScreen() {
    const [info, setInfo] = useState([]);

    useEffect(() => {
        async function fetchdata() {
            const request = await axios
                .get("http://192.168.42.59:3000/Kasur")
                .then((res) => {
            ...
            <ScrollView>
                <Card style={styles.bodyCard}>
                    <Card.Content>
                        ...
                        <View style={styles.contenCard}>
                            <Card.Cover source={require("../assets/kasur/wave.jpg")} style={styles.imageCard} />
                            <View>
                ...
                <Card style={styles.bodyCard}>
                    <Card.Content>
                        ...
                        <View style={styles.contenCard}>
                            <Card.Cover source={require("../assets/kasur/air.jpg")} style={styles.imageCard} />
                            <View>
                                <Text style={styles.descCard}>{info.slice(8, 9).map((info) => (info.desc))}</Text>
                ...
                <Card style={styles.bodyCard}>
                    <Card.Content>
                        ...
                        <View style={styles.contenCard}>
                            <Card.Cover source={require("../assets/kasur/madra.jpg")} style={styles.imageCard} />
                            <View>
                                <Text style={styles.descCard}>{info.slice(8, 9).map((info) => (info.desc))}</Text>
                ...
                <Card style={styles.bodyCard}>
                    <Card.Content>
                        ...
                        <View style={styles.contenCard}>
                            <Card.Cover source={require("../assets/kasur/nordic.jpg")} style={styles.imageCard} />
                            <View>
                                <Text style={styles.descCard}>{info.slice(8, 9).map((info) => (info.desc))}</Text>
                ...
                <Card style={styles.bodyCard}>
                    <Card.Content>
                        ...
                        <View style={styles.contenCard}>
                            <Card.Cover source={require("../assets/kasur/spindle.jpg")} style={styles.imageCard} />
                            <View>
                                <Text style={styles.descCard}>{info.slice(8, 9).map((info) => (info.desc))}</Text>
                ...
                <Card style={styles.bodyCard}>
                    <Card.Content>
                        ...
                        <View style={styles.contenCard}>
                            <Card.Cover source={require("../assets/kasur/basic.jpg")} style={styles.imageCard} />
                            <View>
                                <Text style={styles.descCard}>{info.slice(8, 9).map((info) => (info.desc))}</Text>
                ...
                <Card style={styles.bodyCard}>
                    <Card.Content>
                        ...
                        <View style={styles.contenCard}>
                            <Card.Cover source={require("../assets/kasur/easy.jpg")} style={styles.imageCard} />
                            <View>
                                <Text style={styles.descCard}>{info.slice(8, 9).map((info) => (info.desc))}</Text>
                ...
                <Card style={styles.bodyCard}>
                    <Card.Content>
                        ...
                        <View style={styles.contenCard}>
                            <Card.Cover source={require("../assets/kasur/claude.jpg")} style={styles.imageCard} />
                            <View>
                                <Text style={styles.descCard}>{info.slice(8, 9).map((info) => (info.desc))}</Text>
