    ...
    useEffect(() => {
        async function fetchdata() {
            const request = await axios
                .get("http://192.168.42.59:3000/Sofa")
                .then((res) => {
            ...
            <ScrollView>
                <Card style={styles.bodyCard}>
                    <Card.Content>
                        ...
                        <View style={styles.contenCard}>
                            <Card.Cover source={require("../assets/sofa/mara.jpg")} style={styles.imageCard} />
                            <View>
                ...
                <Card style={styles.bodyCard}>
                    <Card.Content>
                        ...
                        <View style={styles.contenCard}>
                            <Card.Cover source={require("../assets/sofa/arbour.jpg")} style={styles.imageCard} />
                            <View>
                                <Text style={styles.descCard}>{info.slice(8, 9).map((info) => (info.desc))}</Text>
                ...
                <Card style={styles.bodyCard}>
                    <Card.Content>
                        ...
                        <View style={styles.contenCard}>
                            <Card.Cover source={require("../assets/sofa/pop.jpg")} style={styles.imageCard} />
                            <View>
                                <Text style={styles.descCard}>{info.slice(8, 9).map((info) => (info.desc))}</Text>
                ...
                <Card style={styles.bodyCard}>
                    <Card.Content>
                        ...
                        <View style={styles.contenCard}>
                            <Card.Cover source={require("../assets/sofa/swell.jpg")} style={styles.imageCard} />
                            <View>
                                <Text style={styles.descCard}>{info.slice(8, 9).map((info) => (info.desc))}</Text>
                ...
                <Card style={styles.bodyCard}>
                    <Card.Content>
                        ...
                        <View style={styles.contenCard}>
                            <Card.Cover source={require("../assets/sofa/aal.jpg")} style={styles.imageCard} />
                            <View>
                                <Text style={styles.descCard}>{info.slice(8, 9).map((info) => (info.desc))}</Text>
                ...
                <Card style={styles.bodyCard}>
                    <Card.Content>
                        ...
                        <View style={styles.contenCard}>
                            <Card.Cover source={require("../assets/sofa/popduo.jpg")} style={styles.imageCard} />
                            <View>
                                <Text style={styles.descCard}>{info.slice(8, 9).map((info) => (info.desc))}</Text>
                ...
                <Card style={styles.bodyCard}>
                    <Card.Content>
                        ...
                        <View style={styles.contenCard}>
                            <Card.Cover source={require("../assets/sofa/foliage.jpg")} style={styles.imageCard} />
                            <View>
                                <Text style={styles.descCard}>{info.slice(8, 9).map((info) => (info.desc))}</Text>
                ...
                <Card style={styles.bodyCard}>
                    <Card.Content>
                        ...
                        <View style={styles.contenCard}>
                            <Card.Cover source={require("../assets/sofa/popoutdoor.jpg")} style={styles.imageCard} />
                            <View>
                                <Text style={styles.descCard}>{info.slice(8, 9).map((info) => (info.desc))}</Text>
