    ...
    useEffect(() => {
        async function fetchdata() {
            const request = await axios
                .get("http://192.168.42.59:3000/Vas")
                .then((res) => {
            ...
            <ScrollView>
                <Card style={styles.bodyCard}>
                    <Card.Content>
                        ...
                        <View style={styles.contenCard}>
                            <Card.Cover source={require("../assets/vas/roman.jpg")} style={styles.imageCard} />
                            <View>
                ...
                <Card style={styles.bodyCard}>
                    <Card.Content>
                        ...
                        <View style={styles.contenCard}>
                            <Card.Cover source={require("../assets/vas/hongkong.jpg")} style={styles.imageCard} />
                            <View>
                                <Text style={styles.descCard}>{info.slice(8, 9).map((info) => (info.desc))}</Text>
                ...
                <Card style={styles.bodyCard}>
                    <Card.Content>
                        ...
                        <View style={styles.contenCard}>
                            <Card.Cover source={require("../assets/vas/tribal.jpg")} style={styles.imageCard} />
                            <View>
                                <Text style={styles.descCard}>{info.slice(8, 9).map((info) => (info.desc))}</Text>
                ...
                <Card style={styles.bodyCard}>
                    <Card.Content>
                        ...
                        <View style={styles.contenCard}>
                            <Card.Cover source={require("../assets/vas/magnolia.jpg")} style={styles.imageCard} />
                            <View>
                                <Text style={styles.descCard}>{info.slice(8, 9).map((info) => (info.desc))}</Text>
                ...
                <Card style={styles.bodyCard}>
                    <Card.Content>
                        ...
                        <View style={styles.contenCard}>
                            <Card.Cover source={require("../assets/vas/cobra.jpg")} style={styles.imageCard} />
                            <View>
                                <Text style={styles.descCard}>{info.slice(8, 9).map((info) => (info.desc))}</Text>
                ...
                <Card style={styles.bodyCard}>
                    <Card.Content>
                        ...
                        <View style={styles.contenCard}>
                            <Card.Cover source={require("../assets/vas/romanbrown.jpg")} style={styles.imageCard} />
                            <View>
                                <Text style={styles.descCard}>{info.slice(8, 9).map((info) => (info.desc))}</Text>
                ...
                <Card style={styles.bodyCard}>
                    <Card.Content>
                        ...
                        <View style={styles.contenCard}>
                            <Card.Cover source={require("../assets/vas/edison.jpg")} style={styles.imageCard} />
                            <View>
                                <Text style={styles.descCard}>{info.slice(8, 9).map((info) => (info.desc))}</Text>
                ...
                <Card style={styles.bodyCard}>
                    <Card.Content>
                        ...
                        <View style={styles.contenCard}>
                            <Card.Cover source={require("../assets/vas/splash.jpg")} style={styles.imageCard} />
                            <View>
                                <Text style={styles.descCard}>{info.slice(8, 9).map((info) => (info.desc))}</Text>
