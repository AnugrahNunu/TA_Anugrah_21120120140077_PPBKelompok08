    ...
    useEffect(() => {
        async function fetchdata() {
            const request = await axios
                .get("http://192.168.42.59:3000/Rak")
                .then((res) => {
            ...
            <ScrollView>
                <Card style={styles.bodyCard}>
                    <Card.Content>
                        ...
                        <View style={styles.contenCard}>
                            <Card.Cover source={require("../assets/rak/sound.jpg")} style={styles.imageCard} />
                            <View>
                ...
                <Card style={styles.bodyCard}>
                    <Card.Content>
                        ...
                        <View style={styles.contenCard}>
                            <Card.Cover source={require("../assets/rak/fluida.jpg")} style={styles.imageCard} />
                            <View>
                                <Text style={styles.descCard}>{info.slice(8, 9).map((info) => (info.desc))}</Text>
                ...
                <Card style={styles.bodyCard}>
                    <Card.Content>
                        ...
                        <View style={styles.contenCard}>
                            <Card.Cover source={require("../assets/rak/linear.jpg")} style={styles.imageCard} />
                            <View>
                                <Text style={styles.descCard}>{info.slice(8, 9).map((info) => (info.desc))}</Text>
                ...
                <Card style={styles.bodyCard}>
                    <Card.Content>
                        ...
                        <View style={styles.contenCard}>
                            <Card.Cover source={require("../assets/rak/book7492.jpg")} style={styles.imageCard} />
                            <View>
                                <Text style={styles.descCard}>{info.slice(8, 9).map((info) => (info.desc))}</Text>
                ...
                <Card style={styles.bodyCard}>
                    <Card.Content>
                        ...
                        <View style={styles.contenCard}>
                            <Card.Cover source={require("../assets/rak/cantinetta.jpg")} style={styles.imageCard} />
                            <View>
                                <Text style={styles.descCard}>{info.slice(8, 9).map((info) => (info.desc))}</Text>
                ...
                <Card style={styles.bodyCard}>
                    <Card.Content>
                        ...
                        <View style={styles.contenCard}>
                            <Card.Cover source={require("../assets/rak/metalpop.jpg")} style={styles.imageCard} />
                            <View>
                                <Text style={styles.descCard}>{info.slice(8, 9).map((info) => (info.desc))}</Text>
                ...
                <Card style={styles.bodyCard}>
                    <Card.Content>
                        ...
                        <View style={styles.contenCard}>
                            <Card.Cover source={require("../assets/rak/hosoi0961.jpg")} style={styles.imageCard} />
                            <View>
                                <Text style={styles.descCard}>{info.slice(8, 9).map((info) => (info.desc))}</Text>
                ...
                <Card style={styles.bodyCard}>
                    <Card.Content>
                        ...
                        <View style={styles.contenCard}>
                            <Card.Cover source={require("../assets/rak/battista.jpg")} style={styles.imageCard} />
                            <View>
                                <Text style={styles.descCard}>{info.slice(8, 9).map((info) => (info.desc))}</Text>
